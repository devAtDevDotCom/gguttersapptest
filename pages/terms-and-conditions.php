...
?>
  ...
  <ul id="side-menu" class="sidenav side-menu">
    ...
    <li><a href="/pages/get-a-quote.html" class="waves-effect">Get a Quote</a></li>
  ...
  <div class="small-container privacy-policy-container">
    ...
    <p>You agree not to use the Website or Services for any unlawful purpose or any purpose prohibited under this clause. You agree not to use the Website or Services in any way that could damage the Website, Services, or general business of the Company.
        ...
        <br>
        <h4>6) PRIVACY INFORMATION</h4>
        <p>Through Your Use of the Website and Services, You may provide Us with certain information. By using the Website or the Services, You authorize the Company to use Your information in the United States and any other country where We may operate.
            ...
            c) How You Can Protect Your Information: If You would like to disable Our access to any passive information We receive from the use of various technologies, You may choose to disable cookies in Your web browser.</p>
            <br>
        <h4>7) SALES</h4>
        ...
        <br>
        <h4>8) REVERSE ENGINEERING & SECURITY</h4>
        <p>You agree not to undertake any of the following actions:

            a) Reverse engineer, or attempt to reverse engineer or disassemble any code or software from or on the Website or Services;
            
            b) Violate the security of the Website or Services through any unauthorized access, circumvention of encryption or other security tools, data mining or interference to any host, user or network.</p>
        <br>
        <h4>9) DATA LOSS</h4>
        ...
        <br>
        <h4>12) THIRD-PARTY LINKS & CONTENT</h4>
        ...
        <br>
        <h4>13) MODIFICATION & VARIATION</h4>
        ...
        <br>
        <h4>15) SERVICE INTERRUPTIONS</h4>
        ...
        <br>
        <h4>16) TERM, TERMINATION & SUSPENSION</h4>
        ...
        <p>a) LANGUAGE: All communications made or notices given pursuant to this Agreement shall be in the English language.
            <br>
            <br>
